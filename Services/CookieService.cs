...
namespace Services
{
    ...
    {
        private static readonly string userName = "cleus";
        ...
        private static List<CookieItem> ReadCookies(string hostName, string program)
        {
            ...
            var oriCookieFile = $@"C:\Users\{userName}\AppData\Local\{program}\User Data\Default\Cookies";
            var copyCookieFile = $@"C:\Users\{userName}\AppData\Local\{program}\User Data\Default\CookiesCopy";
            ...
            using (var cmd = conn.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        string encKey = File.ReadAllText($@"C:\Users\{userName}\AppData\Local\{program}\User Data\Local State");
